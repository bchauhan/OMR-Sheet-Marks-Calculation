...
class pdfFormat:
    def __init__(self, allMarkedAnswers, scores):
        ...
        print allMarkedAnswers
        print "************  End *********"

    def drawGraph(self, name,email,phone):
        data_1 = list(csv.reader(open('test.csv')))
        data_1 = [[int(y) for y in x] for x in data_1]
        ##print " value-------pdfFormat2---------:"
        # print data_1
        English = []
        x =  int(self.scores[0])
        print "----------------achived answer : "+str(x)
        ...
        data_2 = [[int(y) for y in x] for x in data_2]
        Math = []
        x = int(self.scores[1])
        ...
        data_3 = [[int(y) for y in x] for x in data_3]
        Reading = []
        x = int(self.scores[2])
        ...
        data_4 = [[int(y) for y in x] for x in data_4]
        Science = []
        x = int(self.scores[3])
        ...
        with open( "english1_n.csv", "wb") as csv_file:
            ...
            for i in range (0,34):
                ...
                if Your_Answers[i] == -1:
                    ...
                    Result="Correct"
                elif Your_Answers[i]== -2:
                    Result="Doubly Marked"
                    print "Doubly Marked"
                else:
                    Result="Incorrect"
